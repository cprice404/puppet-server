...
(def jvm-puppet-conf
  {:global       {:logging-config       "/home/cprice/work/jvm-puppet/conf/logback.xml"}
   :os-settings  {:ruby-load-path       ["./ruby/puppet/lib" "./ruby/facter/lib"]}
   :jruby-puppet {:gem-home             "./target/jruby-gems"
                  :max-active-instances 2
                  :master-conf-dir      "/home/cprice/work/jvm-puppet/conf/master-conf"
                  :master-var-dir       "/home/cprice/work/jvm-puppet/conf/master-var"}
